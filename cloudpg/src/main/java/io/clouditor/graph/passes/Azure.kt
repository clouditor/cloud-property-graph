                        ...
                        eog.followEOG {
                            it.end is MemberCallExpression &&
                                ...
                                (it.end as MemberCallExpression).base?.name?.localName ==
                                    "getBlobClient" &&
                                (((it.end as MemberCallExpression).base as MemberCallExpression)
                                        .base as
...
class AzurePass : CloudResourceDiscoveryPass() {
    ...
    private fun handleWorkspace(t: TranslationResult, workspace: Workspace): Logging {
        ...
        logging.name = Name(workspace.name())
